                    ...
                    <form onSubmit={handleSubmit} onReset={()=>{setselectValue(null)}} className="bg-white w-1/2  h-fit rounded-md shadow-md flex flex-col items-center gap-2">
                        ...
                        <div className="w-full px-8 flex gap-2 justify-start items-center">
                            <div className="flex flex-col gap-3  w-1/2">
                                    ...
                                    <input type="text" id="Reference" placeholder="Reference" name="Reference"  className={"input-base w-full px-4 py-2 text-xs  " + (Error[2]?"border-red-500":"")}/>
                        ...
                        <div className="w-full  flex flex-col justify-center items-center gap-8 px-8">
                             <div className="flex flex-col gap-3  w-full">
                                    ...
                                    <input type="Date" id="Date"  defaultValue={new Date().toISOString().split('T')[0]} className={"input-base w-full px-4 py-2 text-xs "}/>
                            </div>         
                        </div>
                        ...
                        <div className="w-full  flex flex-col justify-center items-center gap-8 px-8">
                            <div className="flex flex-col gap-3 w-full">
                                    ...
                                    >
                                        ...
                                        <SelectItem value="4"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 4 
                                        </SelectItem>
                                        <SelectItem value="5"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 5
                                        </SelectItem>
                                        <SelectItem value="6"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 6
                                        </SelectItem>
                                        <SelectItem value="7"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 7 
                                        </SelectItem>
                                        <SelectItem value="8"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 8 
                                        </SelectItem>
                                        <SelectItem value="9"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 9 
                                        </SelectItem>
                                        <SelectItem value="10"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 10 
                                        </SelectItem>
                                        <SelectItem value="11"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 11 
                                        </SelectItem>
                                        <SelectItem value="12"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 12 
                                        </SelectItem>
                                        <SelectItem value="13"  className="bg-gray-100 hover:bg-primary cursor-pointer hover:text-white text-xs p-4" >
                                        Fournisseur 13 
                                        </SelectItem>
                                    </MySelect>
